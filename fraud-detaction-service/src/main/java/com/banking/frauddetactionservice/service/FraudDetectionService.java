package com.banking.frauddetactionservice.service;

import com.banking.frauddetactionservice.client.AccountServiceClient;
import com.banking.frauddetactionservice.model.FraudCheckResult;
...
public class FraudDetectionService {
    ...
    @Value("${fraud.max-transaction-per-minutes}")
    ...
    private boolean isVelocityExceeded(String accountNumber){
        ...
        log.info("Velocity check - account: {} count: {}/{} ", accountNumber, count,maxTransactionPerMinutes);

        return count != null && count > maxTransactionPerMinutes;
    }
