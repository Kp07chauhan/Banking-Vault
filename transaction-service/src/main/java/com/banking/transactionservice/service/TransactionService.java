...
public class TransactionService {
    ...
    public TransactionResponse transfer(TransferRequest request){
        ...
        accountServiceClient.deductionBalance(
                request.getSenderAccountNumber(),
                request.getAmount()
        );
    ...
    public TransactionResponse getTransaction(String transactionId){
        return mapToResponse(transactionRepository.findById(transactionId)
                .orElseThrow(()-> new RuntimeException("TransactionId not found: "+transactionId)));
    }
    ...
    public TransactionResponse verifyOTP(String transactionId, String otp){
        ...
        log.info("OTP verification - complete transaction: {}", transactionId);
        redisTemplate.delete(otpKey);
    ...
    private void completeTransaction(Transaction transaction){
        ...
        transaction.setCompleteAt(LocalDateTime.now());
        transactionRepository.save(transaction);
    ...
    private TransactionResponse mapToResponse(Transaction transaction){
        ...
        response.setCreateAt(transaction.getCreatedAt());
        response.setCompleteAt(transaction.getCompleteAt());
